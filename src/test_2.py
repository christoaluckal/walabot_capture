...
# Select scan arena
    #             R             Phi          Theta
ARENA = [(480, 1000, 1.2), (-10, 10, 2), (-20, 20, 2)] # Distance focused
# ARENA = [(480, 1000, 3), (-10, 10, 1), (-20, 20, 1)] # Angle focused
# ARENA = [(480, 1000, 2), (-13, 13, 1.5), (-24, 24, 1.5)] # Distance and angle focused
# ARENA = [(300,600,2.5),(-45,45,2.5),(-22,22,2.5)] # Side profile
